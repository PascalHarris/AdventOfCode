(*
	Joltage Configuration Solver - Part 2
...
set solverSourceFile to choose file with prompt "Select the joltage_solver.m file:"
set solverSource to POSIX path of solverSourceFile

set solverBinary to "/tmp/joltage_solver"
...
display dialog "Total minimum button presses: " & outputString buttons {"OK"} default button 1
return outputString